      ...
      <div className="right">
        ...
        {volunteerDetails && (
          <div className="volunteer-details">
            ...
            <p><strong>Name:</strong> {volunteerDetails[0]}</p>
            <p><strong>Skills:</strong> {volunteerDetails[1]}</p>
            <p><strong>Bio:</strong> {volunteerDetails[2]}</p>
            <p><strong>Profile Picture Hash:</strong> {volunteerDetails[3]}</p>
            <p><strong>Dates:</strong> {volunteerDetails[4].join(', ')}</p>
            <p><strong>Times:</strong> {volunteerDetails[5].join(', ')}</p>
          </div>
        )}
      </div>
    </div>
